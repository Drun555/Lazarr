...
def media_streams(
    ...
    for raw in asset.probe.get("streams", []):
        ...
        entry = {
            ...
            "IsExternal": False,
            "IsInterlaced": raw.get("field_order") in {"tt", "bb", "tb", "bt"},
            "IsHearingImpaired": bool(raw.get("disposition", {}).get("hearing_impaired")),
    ...
    for track in external_tracks:
        ...
        entry = {
            ...
            "IsExternal": True,
            "IsHearingImpaired": bool(track.get("hearing_impaired")),
            "IsDefault": False,
    ...
    for stream in streams:
        stream.setdefault("IsInterlaced", False)
        stream.setdefault("IsHearingImpaired", False)
        stream.setdefault("IsTextSubtitleStream", False)
        stream.setdefault("SupportsExternalStream", False)
    audio = sorted(
...
def media_source(
    ...
    return {
        ...
        "HasSegments": bool(jellyfin_resources.media_segments(playable, item_id)),
...
def install_jellyfin_api(app, context):
    ...
    def system_info(request):
        ...
        return {
            ...
            "ServerName": "Lazarr",
            "Version": API_VERSION,
            # Jellyfin SDK discovery rejects other product names (including Wholphin).
    ...
    async def jellyfin_login(payload: dict, request: Request):
        ...
        return {
            ...
            "SessionInfo": {
                ...
                "LastPlaybackCheckIn": "0001-01-01T00:00:00Z",
                "IsActive": True,
