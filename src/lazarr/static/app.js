...
function renderSearchActivity(status) {
  ...
  $('#run-queue').textContent=search.running?'Поиск выполняется':search.pending_requests?'Все задачи поставлены в очередь':'Запустить все задачи';
